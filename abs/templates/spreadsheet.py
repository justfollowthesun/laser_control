...
class SpreadsheetTemplate(QtWidgets.QMainWindow):
    ...
    def createTable(self):
        ...
        self.table_widget.setHorizontalHeaderItem(2, QtWidgets.QTableWidgetItem('Относительное время'))
    ...
    def createMenu(self):
        ...
        self.add_row_above_act = QtWidgets.QAction("Add Row Above", self)
        self.add_row_above_act.triggered.connect(self.addRowAbove)
        self.add_row_below_act = QtWidgets.QAction("Add Row Below", self)
        self.add_row_below_act.triggered.connect(self.addRowBelow)
        self.add_col_before_act = QtWidgets.QAction("Add Column Before", self)
        self.add_col_before_act.triggered.connect(self.addColumnBefore)
        self.add_col_after_act = QtWidgets.QAction("Add Column After", self)
        ...
        self.delete_col_act = QtWidgets.QAction("Delete Column", self)
    ...
    def changeHeader(self):
        ...
        text, ok = QtWidgets.QInputDialog.getText(self, "Enter Header", "Header text:")
        if ok and text != "":
            self.table_widget.setHorizontalHeaderItem(col, QtWidgets.QTableWidgetItem(text))
        else:
            pass
    ...
    def pasteItem(self):
        ...
        if self.item_text != None:
            ...
            self.table_widget.setItem(row, column, QtWidgets.QTableWidgetItem(self.item_text))
