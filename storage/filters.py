...
import logging
import sqlite3
from config import DB_PATH, DB_LOGIN_PATH, DB_DIR
...
class Filters():
    ...
    def __init__(self) -> None:
        ...
        self.connection = sqlite3.connect(DB_MACHINES_PATH)
    ...
    def connect_with_db(self, str_to_search):
        ...
        result = self.cursor.execute("SELECT  FROM users WHERE user_name LIKE ?",(str_to_search)).fetchone()
